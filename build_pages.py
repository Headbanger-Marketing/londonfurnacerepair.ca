#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Content + page assembly for londonfurnacerepair.ca. Run: python3 build_pages.py"""
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>London Furnace Repair, {data["h1"]}</h1>
...
def build_home():
    ...
    out = head(
      ...
      desc=f"London Furnace Repair provides honest, efficient, dependable HVAC service in {CITY}, Ontario, furnace & AC repair, heat pumps & more. Call {PHONE_DISPLAY} for a free quote.",
      path="/",
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p>At <a href="/">London Furnace Repair</a>, we believe every household deserves a comfortable, healthy home. As a licensed, insured HVAC company based in London, Ontario, our mission is simple: keep your home comfortable through every season with the same high standard of care we'd expect in our own homes.</p>
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Is your air conditioner making a strange noise? Ready to upgrade your furnace before winter? Whatever your home comfort need, the <a href="/">London Furnace Repair</a> team is ready to help, without the stress.</p>
  </div>
</section>
...
BLOG = [
 {"slug":"how-often-should-you-service-your-hvac-system-in-london-ontario",
  ...
  "photo_h":1067,
  "photo_alt":"HVAC technician using a flashlight to inspect an outdoor air conditioning unit beside a home",
 ...
 {"slug":"signs-your-furnace-needs-repair-before-a-london-winter",
  ...
  "photo_h":1067,
  "photo_alt":"Gloved technician servicing the internal control panel and pump of a home heating boiler",
 ...
 {"slug":"why-your-air-conditioner-struggles-during-humid-london-summers",
  ...
  "photo_h":1137,
  "photo_alt":"Technician using a manifold gauge to check refrigerant levels on an outdoor air conditioning unit",
